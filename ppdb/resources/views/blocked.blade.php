...
<!-- Mirrored from aprendagames.com/stock/brokebot/errorpages-headless-robot.html?errorcode=404 by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Apr 2020 17:34:30 GMT -->
<head>
...
<link rel="stylesheet" type="text/css" href="{{asset ('notfound/brokebot/css/robot_page.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset ('notfound/brokebot/css/robot_styles.css')}}">
<script src="{{asset ('notfound/cdnjs.cloudflare.com/ajax/libs/gsap/latest/TweenMax.min.js')}}"></script>
<script type="text/javascript" src="{{asset ('notfound/brokebot/js/brokebot.js')}}"></script>
<script src="{{asset ('notfound/brokebot/dist/snap.svg-min.js')}}" type="text/javascript"></script>
...
<body>
	...
	<div>
		...
		<div class="robotpage-bottom-half">
			...
			<div>
				<p id="robot-text">404</p>
				<p>Sepertinya Akunmu Diblokir Admin</p>
				<div class="robot-buttons">
				 <a class="dropdown-item robot-buttons"  href="{{ route('logout') }}"
                      onclick="event.preventDefault();
                      document.getElementById('logout-form').submit();">
                      {{ __(' Logout') }}
                </a><a href="/sendemail" class="dropdown-item robot-buttons">Kirim Pesan</a>
...
<!-- Mirrored from aprendagames.com/stock/brokebot/errorpages-headless-robot.html?errorcode=404 by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Apr 2020 17:34:33 GMT -->
</html>