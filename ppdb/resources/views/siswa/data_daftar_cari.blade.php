                               ...
                               <div class="col-md-12">
                                   <div class="card">
                                       <div class="card-header white">
                                           <h6>Penerimaan Peserta Didik Baru SMKN2 Kec.Guguak <small>tp:2020/2021</small></h6>
                                       </div>
                                       <div class="card my-3 no-b">
                                        ...
                                        <div class="card-body">
                                           ...
                                           @foreach ($formulirs as $data)
                                               @if ($data['status']== 'proses')
                                                    <div class="container">
                                                        hi..{{$data['nama_lengkap']}} <br> kode pendaftaranmu adalah
                                                        <b><i>{{$data['kode']}}</i><b>
                                                    </div>
                                               @endif
                                           @endforeach
